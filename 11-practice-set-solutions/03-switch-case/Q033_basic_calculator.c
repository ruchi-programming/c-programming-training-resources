...
#include <stdio.h>
int main(void){ double a,b; int ch; scanf("%lf%lf%d",&a,&b,&ch); switch(ch){case 1:printf("%.2f\n",a+b);break;case 2:printf("%.2f\n",a-b);break;case 3:printf("%.2f\n",a*b);break;case 4:if(b==0)puts("Division by zero");else printf("%.2f\n",a/b);break;default:puts("Invalid choice");} return 0; }
